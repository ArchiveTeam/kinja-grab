...
More information about the archiving project can be found on the ArchiveTeam wiki: [Kinja](http://archiveteam.org/index.php?title=Kinja)
...
Follow the [instructions on the ArchiveTeam wiki](http://archiveteam.org/index.php?title=Warrior) for installing the Warrior, and select the "Kinja" project in the Warrior interface.
...
**There is a known issue with some packaged versions of rsync. If you get errors during the upload stage, kinja-grab will not work with your rsync version.**
...
6. `screen su -c "cd /home/archiveteam/kinja-grab/; run-pipeline pipeline.py --concurrent 2 --address '127.0.0.1' YOURNICKHERE" archiveteam`
...
### For Alpine Linux:
    ...
    git clone https://github.com/ArchiveTeam/kinja-grab
    cd kinja-grab; ./get-wget-lua.sh
